...
public class FishDiseseList8 extends AppCompatActivity {

    TextView tx1,tx3,tx4,tx5,tx6,tx7,tx8,tx9,tx10,tx11,tx12;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fish_disese_list8);

        String fontPath1 = "fonts/AdorshoLipi_20-07-2007.ttf";
        Typeface tf1 = Typeface.createFromAsset(getAssets(), fontPath1);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle(Html.fromHtml("<b> কৈ মাছের ক্ষত রোগ   </b>"));
