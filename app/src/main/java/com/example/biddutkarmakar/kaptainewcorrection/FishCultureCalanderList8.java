...
public class FishCultureCalanderList8 extends AppCompatActivity {

    TextView tx1,tx2,tx3,tx4,tx5,tx6,tx7,tx8,tx9,tx10,tx11,tx12,tx13,tx14;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fish_culture_calander_list8);
        ...
        actionBar.setTitle(Html.fromHtml("<b> পাবদা মাছের চাষ ব্যবস্থাপনা   </b>"));
