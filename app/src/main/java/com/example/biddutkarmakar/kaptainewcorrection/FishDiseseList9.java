...
public class FishDiseseList9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fish_disese_list9);
        ...
        actionBar.setTitle(Html.fromHtml("<b> শিং মাছের ব্যাকটেরিয়া জনিত রোগ   </b>"));
