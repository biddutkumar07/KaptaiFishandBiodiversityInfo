...
public class FishDiseseList12 extends AppCompatActivity {

    TextView tx2,tx3,tx4,tx5,tx6,tx7,tx8,tx9,tx10,tx11,tx12,tx13,tx14,tx15,tx16;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fish_disese_list12);
        ...
        actionBar.setTitle(Html.fromHtml("<b> জলাশয়ে অক্সিজেন স্বল্পতা, গ্যাসজনিত বিষক্রিয়া   </b>"));
